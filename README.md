...
| # | 프롬프트 | 산출물 |
| --- | --- | --- |
| 1 | 기업 분석 리포트 만들기 | 텍스트 — 이후 모든 단계의 재료 |
| 2 | 이 회사용 이력서 HTML 만들기 | **HTML 파일** — 우선순위 재배치 + 표현 교체 |
| 3 | 이 회사용 자기소개서 HTML 만들기 | **HTML 파일** — 문항별 소제목 + 본문 + 글자 수 |
| 4 | 1분 자기소개 + 매칭표 HTML | **HTML 파일** — 니즈↔경험 매칭표 + 55~70초 스크립트 |
| 5 | 핵심 경험 STAR 답변 HTML | **HTML 파일** — 질문 4개 + STAR 블록 |
| 6 | 예상 질문 10개 + 압박 방어 논리 HTML | **HTML 파일** — 질문 10개 표 + 압박질문 5개 + 역질문 3개 |
